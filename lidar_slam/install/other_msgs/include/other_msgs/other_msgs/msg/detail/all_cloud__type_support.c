...
size_t other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__size_function__AllCloud__ground_flat(
  const void * untyped_member)
{
  const other_msgs__msg__Point__Sequence * member =
    (const other_msgs__msg__Point__Sequence *)(untyped_member);
...
const void * other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__get_const_function__AllCloud__ground_flat(
  const void * untyped_member, size_t index)
{
  const other_msgs__msg__Point__Sequence * member =
    (const other_msgs__msg__Point__Sequence *)(untyped_member);
...
void * other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__get_function__AllCloud__ground_flat(
  void * untyped_member, size_t index)
{
  other_msgs__msg__Point__Sequence * member =
    (other_msgs__msg__Point__Sequence *)(untyped_member);
...
void other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__fetch_function__AllCloud__ground_flat(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const other_msgs__msg__Point * item =
    ((const other_msgs__msg__Point *)
    other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__get_const_function__AllCloud__ground_flat(untyped_member, index));
  other_msgs__msg__Point * value =
    (other_msgs__msg__Point *)(untyped_value);
  *value = *item;
}

void other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__assign_function__AllCloud__ground_flat(
  void * untyped_member, size_t index, const void * untyped_value)
{
  other_msgs__msg__Point * item =
    ((other_msgs__msg__Point *)
    other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__get_function__AllCloud__ground_flat(untyped_member, index));
  const other_msgs__msg__Point * value =
    (const other_msgs__msg__Point *)(untyped_value);
  *item = *value;
}

bool other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__resize_function__AllCloud__ground_flat(
  void * untyped_member, size_t size)
{
  other_msgs__msg__Point__Sequence * member =
    (other_msgs__msg__Point__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__AllCloud_message_member_array[7] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(other_msgs__msg__AllCloud, ground_flat),  // bytes offset in struct
    NULL,  // default value
    other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__size_function__AllCloud__ground_flat,  // size() function pointer
    other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__get_const_function__AllCloud__ground_flat,  // get_const(index) function pointer
    other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__get_function__AllCloud__ground_flat,  // get(index) function pointer
    other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__fetch_function__AllCloud__ground_flat,  // fetch(index, &value) function pointer
    other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__assign_function__AllCloud__ground_flat,  // assign(index, value) function pointer
    other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__resize_function__AllCloud__ground_flat  // resize(index) function pointer
  },
  {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, other_msgs, msg, AllCloud)() {
  ...
  other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__AllCloud_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, other_msgs, msg, Point)();
  other_msgs__msg__AllCloud__rosidl_typesupport_introspection_c__AllCloud_message_member_array[6].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, other_msgs, msg, Point)();
