...
static rosidl_typesupport_introspection_c__MessageMember other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__SegCloud_message_member_array[5] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, other_msgs, msg, SegCloud)() {
  ...
  other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__SegCloud_message_member_array[1].members_ =
