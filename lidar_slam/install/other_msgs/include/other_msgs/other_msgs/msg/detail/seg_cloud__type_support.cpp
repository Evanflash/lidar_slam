...
size_t size_function__SegCloud__grd_ring_str_ind(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SegCloud__grd_ring_str_ind(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void * get_function__SegCloud__grd_ring_str_ind(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void fetch_function__SegCloud__grd_ring_str_ind(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__SegCloud__grd_ring_str_ind(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__SegCloud__grd_ring_str_ind(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__SegCloud__grd_ring_str_ind(untyped_member, index));
  const auto & value = *reinterpret_cast<const int32_t *>(untyped_value);
  item = value;
}

void resize_function__SegCloud__grd_ring_str_ind(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
size_t size_function__SegCloud__grd_ring_end_ind(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SegCloud__grd_ring_end_ind(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void * get_function__SegCloud__grd_ring_end_ind(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void fetch_function__SegCloud__grd_ring_end_ind(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__SegCloud__grd_ring_end_ind(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__SegCloud__grd_ring_end_ind(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__SegCloud__grd_ring_end_ind(untyped_member, index));
  const auto & value = *reinterpret_cast<const int32_t *>(untyped_value);
  item = value;
}

void resize_function__SegCloud__grd_ring_end_ind(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
size_t size_function__SegCloud__ground_cloud(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<other_msgs::msg::Point> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SegCloud__ground_cloud(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<other_msgs::msg::Point> *>(untyped_member);
  return &member[index];
...
void * get_function__SegCloud__ground_cloud(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<other_msgs::msg::Point> *>(untyped_member);
  return &member[index];
...
void fetch_function__SegCloud__ground_cloud(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const other_msgs::msg::Point *>(
    get_const_function__SegCloud__ground_cloud(untyped_member, index));
  auto & value = *reinterpret_cast<other_msgs::msg::Point *>(untyped_value);
  value = item;
}

void assign_function__SegCloud__ground_cloud(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<other_msgs::msg::Point *>(
    get_function__SegCloud__ground_cloud(untyped_member, index));
  const auto & value = *reinterpret_cast<const other_msgs::msg::Point *>(untyped_value);
  item = value;
}

void resize_function__SegCloud__ground_cloud(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<other_msgs::msg::Point> *>(untyped_member);
  member->resize(size);
...
size_t size_function__SegCloud__ground_range(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<float> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SegCloud__ground_range(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<float> *>(untyped_member);
  return &member[index];
...
void * get_function__SegCloud__ground_range(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<float> *>(untyped_member);
  return &member[index];
...
void fetch_function__SegCloud__ground_range(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__SegCloud__ground_range(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__SegCloud__ground_range(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__SegCloud__ground_range(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}

void resize_function__SegCloud__ground_range(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<float> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SegCloud_message_member_array[9] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(other_msgs::msg::SegCloud, grd_ring_str_ind),  // bytes offset in struct
    nullptr,  // default value
    size_function__SegCloud__grd_ring_str_ind,  // size() function pointer
    get_const_function__SegCloud__grd_ring_str_ind,  // get_const(index) function pointer
    get_function__SegCloud__grd_ring_str_ind,  // get(index) function pointer
    fetch_function__SegCloud__grd_ring_str_ind,  // fetch(index, &value) function pointer
    assign_function__SegCloud__grd_ring_str_ind,  // assign(index, value) function pointer
    resize_function__SegCloud__grd_ring_str_ind  // resize(index) function pointer
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(other_msgs::msg::SegCloud, grd_ring_end_ind),  // bytes offset in struct
    nullptr,  // default value
    size_function__SegCloud__grd_ring_end_ind,  // size() function pointer
    get_const_function__SegCloud__grd_ring_end_ind,  // get_const(index) function pointer
    get_function__SegCloud__grd_ring_end_ind,  // get(index) function pointer
    fetch_function__SegCloud__grd_ring_end_ind,  // fetch(index, &value) function pointer
    assign_function__SegCloud__grd_ring_end_ind,  // assign(index, value) function pointer
    resize_function__SegCloud__grd_ring_end_ind  // resize(index) function pointer
  },
  {
    "ground_cloud",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(other_msgs::msg::SegCloud, ground_cloud),  // bytes offset in struct
    nullptr,  // default value
    size_function__SegCloud__ground_cloud,  // size() function pointer
    get_const_function__SegCloud__ground_cloud,  // get_const(index) function pointer
    get_function__SegCloud__ground_cloud,  // get(index) function pointer
    fetch_function__SegCloud__ground_cloud,  // fetch(index, &value) function pointer
    assign_function__SegCloud__ground_cloud,  // assign(index, value) function pointer
    resize_function__SegCloud__ground_cloud  // resize(index) function pointer
  },
  {
    "ground_range",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(other_msgs::msg::SegCloud, ground_range),  // bytes offset in struct
    nullptr,  // default value
    size_function__SegCloud__ground_range,  // size() function pointer
    get_const_function__SegCloud__ground_range,  // get_const(index) function pointer
    get_function__SegCloud__ground_range,  // get(index) function pointer
    fetch_function__SegCloud__ground_range,  // fetch(index, &value) function pointer
    assign_function__SegCloud__ground_range,  // assign(index, value) function pointer
    resize_function__SegCloud__ground_range  // resize(index) function pointer
  }
};
