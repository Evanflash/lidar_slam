...
size_t size_function__AllCloud__ground_flat(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<other_msgs::msg::Point> *>(untyped_member);
  return member->size();
}

const void * get_const_function__AllCloud__ground_flat(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<other_msgs::msg::Point> *>(untyped_member);
  return &member[index];
...
void * get_function__AllCloud__ground_flat(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<other_msgs::msg::Point> *>(untyped_member);
  return &member[index];
...
void fetch_function__AllCloud__ground_flat(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const other_msgs::msg::Point *>(
    get_const_function__AllCloud__ground_flat(untyped_member, index));
  auto & value = *reinterpret_cast<other_msgs::msg::Point *>(untyped_value);
  value = item;
}

void assign_function__AllCloud__ground_flat(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<other_msgs::msg::Point *>(
    get_function__AllCloud__ground_flat(untyped_member, index));
  const auto & value = *reinterpret_cast<const other_msgs::msg::Point *>(untyped_value);
  item = value;
}

void resize_function__AllCloud__ground_flat(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<other_msgs::msg::Point> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AllCloud_message_member_array[7] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(other_msgs::msg::AllCloud, ground_flat),  // bytes offset in struct
    nullptr,  // default value
    size_function__AllCloud__ground_flat,  // size() function pointer
    get_const_function__AllCloud__ground_flat,  // get_const(index) function pointer
    get_function__AllCloud__ground_flat,  // get(index) function pointer
    fetch_function__AllCloud__ground_flat,  // fetch(index, &value) function pointer
    assign_function__AllCloud__ground_flat,  // assign(index, value) function pointer
    resize_function__AllCloud__ground_flat  // resize(index) function pointer
  },
  {
