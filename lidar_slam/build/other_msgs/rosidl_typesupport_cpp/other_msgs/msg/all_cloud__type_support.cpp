...
static const _AllCloud_type_support_symbol_names_t _AllCloud_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, other_msgs, msg, AllCloud)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, other_msgs, msg, AllCloud)),
  }
};
...
{
  return &::other_msgs::msg::rosidl_typesupport_cpp::AllCloud_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, other_msgs, msg, AllCloud)() {
  return get_message_type_support_handle<other_msgs::msg::AllCloud>();
}
