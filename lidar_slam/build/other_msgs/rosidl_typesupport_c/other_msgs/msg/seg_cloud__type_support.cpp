...
static const _SegCloud_type_support_symbol_names_t _SegCloud_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, other_msgs, msg, SegCloud)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, other_msgs, msg, SegCloud)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, other_msgs, msg, SegCloud)() {
  return &::other_msgs::msg::rosidl_typesupport_c::SegCloud_message_type_support_handle;
}
