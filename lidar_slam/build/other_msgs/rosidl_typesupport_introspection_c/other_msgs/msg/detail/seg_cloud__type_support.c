...
size_t other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__size_function__SegCloud__is_ground(
  const void * untyped_member)
{
  const rosidl_runtime_c__int32__Sequence * member =
    (const rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
const void * other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__get_const_function__SegCloud__is_ground(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__int32__Sequence * member =
    (const rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
void * other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__get_function__SegCloud__is_ground(
  void * untyped_member, size_t index)
{
  rosidl_runtime_c__int32__Sequence * member =
    (rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
void other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__fetch_function__SegCloud__is_ground(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const int32_t * item =
    ((const int32_t *)
    other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__get_const_function__SegCloud__is_ground(untyped_member, index));
  int32_t * value =
    (int32_t *)(untyped_value);
  *value = *item;
}

void other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__assign_function__SegCloud__is_ground(
  void * untyped_member, size_t index, const void * untyped_value)
{
  int32_t * item =
    ((int32_t *)
    other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__get_function__SegCloud__is_ground(untyped_member, index));
  const int32_t * value =
    (const int32_t *)(untyped_value);
  *item = *value;
}

bool other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__resize_function__SegCloud__is_ground(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__int32__Sequence * member =
    (rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__SegCloud_message_member_array[6] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(other_msgs__msg__SegCloud, is_ground),  // bytes offset in struct
    NULL,  // default value
    other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__size_function__SegCloud__is_ground,  // size() function pointer
    other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__get_const_function__SegCloud__is_ground,  // get_const(index) function pointer
    other_msgs__msg__SegCloud__rosidl_typesupport_introspection_c__get_function__SegCloud__is_ground,  // get(index) function pointer
