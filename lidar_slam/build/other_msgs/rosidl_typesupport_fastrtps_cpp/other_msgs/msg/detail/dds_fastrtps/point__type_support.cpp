...
#include "other_msgs/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const other_msgs::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<other_msgs::msg::Point *>(
    untyped_ros_message);
...
{
  return &other_msgs::msg::typesupport_fastrtps_cpp::_Point__handle;
}
